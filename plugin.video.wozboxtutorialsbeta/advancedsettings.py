...
fanart=xbmc.translatePath(os.path.join('special://home','addons','plugin.video.wozboxtutorialsbeta','fanart.jpg'))
iconart=xbmc.translatePath(os.path.join('special://home','addons','plugin.video.wozboxtutorialsbeta','icon.png'))
SETTINGS_PATH=xbmc.translatePath(os.path.join('special://profile','addon_data','plugin.video.wozboxtutorialsbeta','settings.xml'))

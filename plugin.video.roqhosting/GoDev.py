...
import maintenance
AddonID = 'plugin.video.roqhosting'
AddonTitle = 'Fab Hosting'
Images=xbmc.translatePath(os.path.join('special://home','addons',AddonID,'resources/art/'));
fanart = Images+'fanart.jpg'
icon = Images+'icon.png'
FabAddon = xbmcaddon.Addon('plugin.video.roqhosting')
ADDON=xbmcaddon.Addon(id='plugin.video.roqhosting')
dialog       =  xbmcgui.Dialog()
dialogprocess =  xbmcgui.DialogProgress()
USERDATA     =  xbmc.translatePath(os.path.join('special://home/userdata/',''))
FabData      =  xbmc.translatePath(os.path.join('special://home/userdata/addon_data/plugin.video.roqhosting/',''))
...
def MLBPass(params):
	if xbmc.getCondVisibility('System.HasAddon(plugin.video.mlbtv)'):
		MLBaddon = xbmcaddon.Addon('plugin.video.mlbtv')
		UserCheck = MLBaddon.getSetting(id='username')
		PassCheck = MLBaddon.getSetting(id='password')
		if UserCheck == 'steelax42@gmail.com' or PassCheck == 'vanhalen1':
			xbmc.executebuiltin('RunAddon(plugin.video.mlbtv)')
			sys.exit(1)
	else:
		pass
	if not xbmc.getCondVisibility('System.HasAddon(plugin.video.mlbtv)'):
		choice = xbmcgui.Dialog().yesno('[COLOR white]Install MLB Pass Addon[/COLOR]', '[COLOR white]This will install the legitimate MLB Pass addon & Repository[/COLOR]', ' ', '[COLOR white]Proceed if you accept this[/COLOR]', nolabel='[COLOR white]No, Cancel this[/COLOR]',yeslabel='[COLOR white]Proceed[/COLOR]')
		if choice == 0:
			sys.exit(1)
		elif choice == 1:
			pass
		xbmc.executebuiltin("ActivateWindow(busydialog)")
		install('BS4','http://fabiptv.com/addons/installs/script.module.beautifulsoup4-4.3.2.zip')
		install('PYTZ','http://fabiptv.com/addons/installs/script.module.pytz-2014.2.zip')
		install('SJSON','http://fabiptv.com/addons/installs/script.module.simplejson-3.3.0.zip')
		xbmc.executebuiltin("UpdateAddonRepos")
		xbmc.executebuiltin("UpdateLocalAddons")
		time.sleep(5)
		install('MLB','https://raw.githubusercontent.com/eracknaphobia/repo.eracknaphobia/master/addons/plugin.video.mlbtv/plugin.video.mlbtv-2017.4.12.zip')
		install('MLB Repo','https://raw.githubusercontent.com/eracknaphobia/repo.eracknaphobia/master/repository.eracknaphobia.zip')
		time.sleep(2)
		BS4Enable = '{"jsonrpc":"2.0","method":"Addons.SetAddonEnabled","params":{"addonid":"script.module.beautifulsoup4","enabled":true},"id":1}'
		PyTZEnable = '{"jsonrpc":"2.0","method":"Addons.SetAddonEnabled","params":{"addonid":"script.module.pytz","enabled":true},"id":1}'
		SJSONEnable = '{"jsonrpc":"2.0","method":"Addons.SetAddonEnabled","params":{"addonid":"script.module.simplejson","enabled":true},"id":1}'
		MLBEnable = '{"jsonrpc":"2.0","method":"Addons.SetAddonEnabled","params":{"addonid":"plugin.video.mlbtv","enabled":true},"id":1}'
		MLBRepoEnable = '{"jsonrpc":"2.0","method":"Addons.SetAddonEnabled","params":{"addonid":"repository.eracknaphobia","enabled":true},"id":1}'		
		xbmc.executeJSONRPC(BS4Enable)
		xbmc.executeJSONRPC(PyTZEnable)
		xbmc.executeJSONRPC(SJSONEnable)
		xbmc.executeJSONRPC(MLBEnable)
		xbmc.executeJSONRPC(MLBRepoEnable)
		time.sleep(1)
		xbmc.executebuiltin("UpdateAddonRepos")
		xbmc.executebuiltin("UpdateLocalAddons")
		time.sleep(5)
	else:
		choice = xbmcgui.Dialog().yesno('[COLOR white]MLB Already Installed[/COLOR]', '[COLOR white]You already have MLB installed, if you\'re logged in this will wipe your credentials[/COLOR]', ' ', '[COLOR white]Proceed if you accept this[/COLOR]', nolabel='[COLOR white]OK, Cancel this[/COLOR]',yeslabel='[COLOR white]Proceed[/COLOR]')
		if choice == 0:
			sys.exit(1)
		elif choice == 1:
			pass
	MLBaddon = xbmcaddon.Addon('plugin.video.mlbtv')
	MLBaddon.setSetting(id='username', value='steelax42@gmail.com')
	MLBaddon.setSetting(id='password', value='vanhalen1')
	xbmc.executebuiltin("Dialog.Close(busydialog)")
	dialog.ok("[COLOR white]MLB Pass Ready![/COLOR]",'[COLOR white]MLB Pass is now setup, you can access this directly[/COLOR]','[COLOR white]or through the addon itself, if you have issues[/COLOR]','[COLOR white]Please contact us through the normal methods[/COLOR]')
	xbmc.executebuiltin('Notification(MLB Ready,[COLOR white]Click MLB Pass now to access it[/COLOR],3000,special://home/addons/'+AddonID+'/icon.png)')

def FabSports(params):
	if not xbmc.getCondVisibility('System.HasAddon(plugin.video.fabsportreplays)'):
		choice = xbmcgui.Dialog().yesno('[COLOR white]Install Fab Sports Replays Addon?[/COLOR]', '[COLOR white]This will install the Fab Sports Replays addon[/COLOR]', ' ', '[COLOR white]Proceed if you accept this[/COLOR]', nolabel='[COLOR white]No, Cancel this[/COLOR]',yeslabel='[COLOR white]Proceed[/COLOR]')
		if choice == 0:
			sys.exit(1)
		elif choice == 1:
			pass
		...
		install('BS4','http://fabiptv.com/addons/installs/script.module.beautifulsoup4-4.3.2.zip')
		install('URL Resolver','http://fabiptv.com/addons/installs/script.module.urlresolver-4.0.08.zip')
		install('Fab Sport Replays','http://fabiptv.com/addons/plugin.video.fabsportreplays/plugin.video.fabsportreplays-0.1.zip')
		BS4Enable = '{"jsonrpc":"2.0","method":"Addons.SetAddonEnabled","params":{"addonid":"script.module.beautifulsoup4","enabled":true},"id":1}'
		URLEnable = '{"jsonrpc":"2.0","method":"Addons.SetAddonEnabled","params":{"addonid":"script.module.urlresolver","enabled":true},"id":1}'
		FabEnable = '{"jsonrpc":"2.0","method":"Addons.SetAddonEnabled","params":{"addonid":"plugin.video.fabsportreplays","enabled":true},"id":1}'
		xbmc.executebuiltin("ActivateWindow(busydialog)")
		time.sleep(1)
		xbmc.executebuiltin("UpdateAddonRepos")
		xbmc.executebuiltin("UpdateLocalAddons")
		time.sleep(5)
		xbmc.executeJSONRPC(BS4Enable)
		xbmc.executeJSONRPC(URLEnable)
		xbmc.executeJSONRPC(FabEnable)
		time.sleep(2)
		xbmc.executebuiltin("Dialog.Close(busydialog)")
		Replayaddon = xbmcaddon.Addon('plugin.video.fabsportreplays')
		Replayaddon.setSetting(id='Username', value=Username)
		Replayaddon.setSetting(id='Password', value=Password)
		xbmc.executebuiltin('Notification(Fab Sports Replays Ready,[COLOR white]Click it again to access it[/COLOR],3000,special://home/addons/'+AddonID+'/icon.png)')
	else:
		xbmc.executebuiltin('RunAddon(plugin.video.fabsportreplays)')
...
def SpeedChoice():
	...
	if choice == 0:
		xbmc.executebuiltin('Runscript("special://home/addons/plugin.video.roqhosting/speedtest.py")')
	if choice == 1:
		xbmc.executebuiltin('Runscript("special://home/addons/plugin.video.roqhosting/fastload.py")')
...
if mode == 6:
	...
	disablePVR()
        ...
        xbmc.executebuiltin('Runscript("special://home/addons/plugin.video.roqhosting/loguploader.py")')
elif mode == 100:
		DCtest()
elif mode == 101:
		CAN()

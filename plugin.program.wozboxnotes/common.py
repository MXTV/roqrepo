...
#import common
addon_id='plugin.program.wozboxnotes'
...
DefaultSplitter="|||"; 
DefaultUrl="http://wozboxtv.com/downloads/notifications64x/note.txt"; 
class MyWindow(xbmcgui.WindowDialog): #xbmcgui.Window): ##xbmcgui.Window
	scr={}; scr['L']=0; scr['T']=0; scr['W']=1280; scr['H']=720; 
	def __init__(self,noteType='t',noteMessage='',noteImage='',L=140,T=110,W=1000,H=600,Font='font14',TxtColor='0xFF64d1ff'):

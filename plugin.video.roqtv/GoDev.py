...
FabAddon = xbmcaddon.Addon('plugin.video.roqtv')
ADDON=xbmcaddon.Addon(id='plugin.video.roqtv')
dialog       =  xbmcgui.Dialog()
dialogprocess =  xbmcgui.DialogProgress()
USERDATA     =  xbmc.translatePath(os.path.join('special://home/userdata/',''))
FabData      =  xbmc.translatePath(os.path.join('special://home/userdata/addon_data/plugin.video.roqtv/',''))
...
def SpeedChoice():
	...
	if choice == 0:
		xbmc.executebuiltin('Runscript("special://home/addons/plugin.video.roqtv/speedtest.py")')
	if choice == 1:
		xbmc.executebuiltin('Runscript("special://home/addons/plugin.video.roqtv/fastload.py")')
...
if mode == 6:
	...
	disablePVR()
        ...
        xbmc.executebuiltin('Runscript("special://home/addons/plugin.video.roqtv/loguploader.py")')
elif mode == 100:
		DCtest()
elif mode == 101:
		CAN()
